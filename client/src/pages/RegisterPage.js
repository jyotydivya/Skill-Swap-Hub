      ...
      <div style={{
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 14, color: '#6b7280' }}>
            Create your free account and start exchanging skills
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 14 }}>
            <div>
              ...
              <input name="firstName" value={form.firstName}
                onChange={handleChange} required placeholder="Arjun"
                style={inputStyle} />
            </div>
            <div>
              <label style={labelStyle}>Last Name</label>
              <input name="lastName" value={form.lastName}
                onChange={handleChange} required placeholder="Kumar"
                style={inputStyle} />
            </div>
          </div>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <input name="location" value={form.location}
              onChange={handleChange} placeholder="Hyderabad, India"
              style={inputStyle} />
          </div>
        ...
        <p style={{ textAlign: 'center', fontSize: 13, color: '#6b7280', marginTop: 20 }}>
          ...
          <Link to="/login" style={{ color: '#1a7a5e', fontWeight: 600 }}>Login</Link>
        </p>
      </div>
    </div>
  );
